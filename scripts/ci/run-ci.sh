...
db_gates_unproven=0
for gate in OWL_TEST_DATABASE_URL OWL_MIGRATOR_DATABASE_URL OWL_LEDGER_ANCHOR_DATABASE_URL OWL_LEDGER_DDL_DATABASE_URL OWL_MIGRATOR_STALE_DATABASE_URL OWL_BOOTSTRAP_SUPERUSER_DATABASE_URL OWL_MIGRATOR_UNPROVISIONED_DATABASE_URL OWL_SCHEMASQL_ONLY_DATABASE_URL OWL_MIGRATOR_RESTORED_DATABASE_URL OWL_MIGRATOR_CLONED_DATABASE_URL; do
